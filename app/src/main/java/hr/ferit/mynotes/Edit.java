...
public class Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // nTitle = findViewById(R.id.noteTitle);
        ...
        nContent.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.save){
            Note note = new Note(nId,nContent.getText().toString(),todaysDate,currentTime);
            ...
            goToMain();
            Toast.makeText(this, "Bilješka uređena", Toast.LENGTH_SHORT).show();
